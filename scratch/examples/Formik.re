...
module CreateForm = (Config: CreateFormType) => {
  ...
  module FormikProps = {
    type t;
    [@bs.send] external handleChange : (t, ReactEvent.Form.t) => unit = "";
    [@bs.send] external handleBlur : (t, ReactEvent.Focus.t) => unit = "";
    [@bs.send] external handleSubmit : (t, ReactEvent.Form.t) => unit = "";
    [@bs.send]
